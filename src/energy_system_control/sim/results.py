...
class SimulationResults:
    ...
    def get_cumulated_electricity(self, port_name: str, time_interval_h: Tuple[float, float] = None, unit: str = "kWh", sign: str = "net"):
        ...
        match sign:
            case "net":
                return self._get_cumulated_result(port_name, "electricity", time_interval_h, scaling_factor)
            case "only positive" | "only negative":
                return self._get_cumulated_result_with_sign(port_name, "electricity", sign, time_interval_h, scaling_factor)
